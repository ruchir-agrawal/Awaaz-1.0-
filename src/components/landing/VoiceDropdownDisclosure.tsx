...
//             <div
//                 className={`absolute left-0 top-[calc(100%+0.85rem)] z-20 w-full origin-top transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] ${isOpen
...
//                                         <div
//                                             className={`flex h-6 w-6 items-center justify-center rounded-full border-2 transition-all ${active ? "border-white bg-white" : "border-white/15"
//                                                 }`}
//                                         >
...
/* ── VoiceDropdownDisclosure kept for backward-compat imports ─────── */
/* The hero now renders an inline flat picker; this component is unused */
export const VoiceDropdownDisclosure = () => null