...
export default function Landing() {
    ...
    return (
        <div className="relative min-h-screen overflow-x-hidden bg-[#080808] text-[#f0ede8]" style={{ fontFamily: "'Inter', sans-serif", fontSize: "15px" }}>
            <header className="fixed top-5 z-50 flex w-full justify-center px-6">
                <nav className="flex max-w-fit items-center justify-between space-x-10 rounded-full border border-white/5 bg-white/[0.03] px-7 py-3 shadow-2xl backdrop-blur-xl">
                    <div className="flex items-center gap-3 border-r border-white/5 pr-4">
                        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-white">
                            <Mic className="w-3 text-black" />
                        </div>
            ...
            <section className="relative flex min-h-screen flex-col justify-center overflow-hidden pt-16">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-8 pb-16 pt-24 xl:-translate-x-12">
                    <div className="grid gap-10 xl:grid-cols-2 xl:items-center">
                        <div>

                            <h1 className="mb-8 text-[clamp(3.2rem,7.5vw,6.8rem)] leading-[0.87] tracking-tight">
                                <span className="block text-white" style={{ fontFamily: "'Instrument Serif', serif", fontStyle: "italic" }}>
                                    Never miss
                                </span>
                                <span className="block text-white/10" style={{ fontFamily: "'Instrument Serif', serif", fontStyle: "italic" }}>
                            ...
                            <p className="max-w-xl text-[16px] leading-[1.65] text-white/35">
                                Awaaz handles your business calls 24/7 in native dialects, booking appointments, routing leads, and ensuring no revenue is ever left on the table.
                            </p>
                            ...
                            <div className="mt-10">
                                <Link
                                    to="/signup"
                                    className="group inline-flex h-[52px] items-center gap-3 rounded-full bg-white px-8 text-[14px] font-black text-black shadow-2xl transition-all hover:bg-white/90 active:scale-95"
                                >
                                    Start for free
            ...
            <section className="mx-auto max-w-7xl px-8 py-28">
                <div className="grid gap-px overflow-hidden rounded-[2.5rem] border border-white/5 bg-white/5 md:grid-cols-3">
                    {[
                        ...
                        <div key={stat.label} className="bg-[#0b0b0b] px-9 py-9 transition-colors hover:bg-[#111]">
                            <div
                                className="mb-3 text-[clamp(1.6rem,3.8vw,2.5rem)] font-black leading-none text-white tabular-nums"
                                style={{ fontFamily: "'Syne', sans-serif" }}
                            >
                                <Counter target={stat.value} suffix={stat.suffix} />
                            </div>
                            <div className="text-[12px] font-semibold uppercase tracking-wide text-white/40">{stat.label}</div>
                        </div>
                    ))}
                </div>
            </section>

            <section id="features" className="mx-auto max-w-7xl px-8 py-20">
                <div className="mb-16 flex items-center gap-8">
                    <span className="shrink-0 text-[11px] font-black uppercase tracking-[0.4em] text-white/20">Capabilities</span>
                    <div className="h-px w-full bg-gradient-to-r from-white/10 to-transparent" />
                </div>
                ...
                <div className="grid gap-px overflow-hidden rounded-[2.5rem] border border-white/5 bg-white/5 md:grid-cols-3">
                    {[
                        ...
                        <div key={feature.number} className="group bg-[#0b0b0b] p-10 transition-all duration-500 hover:bg-[#141414]">
                            ...
                            <h3 className="mb-4 text-xl font-black uppercase tracking-tighter text-white" style={{ fontFamily: "'Syne', sans-serif" }}>
                                {feature.title}
                            </h3>
                            <p className="text-[14px] font-medium leading-relaxed text-white/30">{feature.body}</p>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section id="about" className="mx-auto max-w-7xl px-8 py-32">
                <div className="grid items-center gap-32 lg:grid-cols-2">
                    <div>
                        <div className="mb-10 text-[13px] font-black uppercase tracking-[0.3em] text-white/20">Our mission</div>
                        <h2 className="mb-10 text-[clamp(2rem,4.5vw,4rem)] leading-[0.95]">
                            <span className="text-white" style={{ fontFamily: "'Instrument Serif', serif", fontStyle: "italic" }}>
                                Every
                            </span>{" "}
                            business deserves a{" "}
                        ...
                        <div className="space-y-6 text-[15px] font-medium leading-relaxed text-white/30">
                            <p>
                                Awaaz was built to bridge the gap between small businesses and their customers. We give every clinic, salon, and office an AI receptionist that works 24/7.
                            </p>
                            <p>
                        ...
                        <div className="relative rounded-[3rem] border border-white/5 bg-[#0d0d0d]/80 p-10 shadow-2xl backdrop-blur-md">
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    <div key={`${message.who}-${message.text}`} className={`flex items-start gap-4 ${message.who === "Awaaz AI" ? "flex-row-reverse" : ""}`}>
                                        <div
                                            className={`flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-xl text-[11px] font-black ${message.who === "Awaaz AI"
                                                    ? "bg-white text-black"
                                                    : "border border-white/5 bg-white/5 text-white/40"
                                                }`}
                                        >
                                        ...
                                        <div className={`flex max-w-[75%] flex-col gap-1.5 ${message.who === "Awaaz AI" ? "items-end" : "items-start"}`}>
                                            <div
                                                className={`rounded-[1.5rem] px-5 py-3.5 text-[15px] font-medium ${message.who === "Awaaz AI"
                                                        ? "bg-white leading-snug text-black"
                                                        : "border border-white/5 bg-white/5 text-white/70"
                                                    }`}
                                            >
            ...
            <section id="how" className="relative border-t border-white/5 bg-[#0b0b0b] py-24">
                <div className="mx-auto max-w-7xl px-8">
                    <div className="mb-16 text-center text-[11px] font-black uppercase tracking-[0.4em] text-white/20">
                        Operation Lifecycle
                    </div>
                    ...
                    <div className="grid gap-14 md:grid-cols-3">
                        {[
                            ...
                            <div key={step.n} className="group relative text-center md:text-left">
                                <div
                                    className="mb-6 select-none text-[90px] font-black leading-[0.8] text-white/[0.04] tabular-nums transition-all duration-700 group-hover:scale-110 group-hover:text-white/[0.08]"
                                    style={{ fontFamily: "'Syne', sans-serif", transformOrigin: "left" }}
                                >
                                    {step.n}
                                </div>
                                <h4 className="mb-3 text-xl font-black uppercase tracking-tighter text-white" style={{ fontFamily: "'Syne', sans-serif" }}>
                                    {step.title}
                                </h4>
                                <p className="mx-auto max-w-[260px] text-[14px] font-medium leading-relaxed text-white/30 md:mx-0">{step.body}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="mx-auto max-w-7xl px-8 py-32">
                <div className="relative overflow-hidden rounded-[3rem] border border-white/5 bg-[#0e0e0e] shadow-2xl">
                    <div className="absolute inset-0" style={{ opacity: 0.12, mixBlendMode: "screen" }}>
                        <ShaderAnimation />
                    </div>
                    <div
                    ...
                    <div className="relative z-10 px-8 py-24 text-center">
                        <div className="mb-8 text-[11px] font-black uppercase tracking-[0.4em] text-white/20">
                            Ready to transform?
                        </div>
                        <h2 className="mb-12 text-[clamp(2.4rem,6.5vw,5.5rem)] leading-[0.9] tracking-tighter">
                            <span className="text-white" style={{ fontFamily: "'Instrument Serif', serif", fontStyle: "italic" }}>
                                Your receptionist
                            </span>
                            <br />
                        ...
                        <Link
                            to="/signup"
                            className="group inline-flex items-center gap-3 rounded-full bg-white px-10 py-5 text-[15px] font-black text-black shadow-2xl transition-all hover:bg-white/90 active:scale-95"
                        >
                            Start for free - no card needed
                            <ArrowUpRight className="h-4 w-4 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
                        </Link>
                ...
                <div className="mx-auto max-w-7xl px-8">
                    <div className="flex items-center gap-4">
                        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white">
                            <Mic className="w-5 text-black" />
                        </div>
                        <span className="text-4xl tracking-tighter text-white" style={{ fontFamily: "'Instrument Serif', serif", fontStyle: "italic", fontWeight: 600 }}>
                            Awaaz
                        </span>
                    </div>
                </div>
