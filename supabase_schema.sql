...
-- Trigger: auto-create profile and default business on signup
...
BEGIN
  ...
  -- Auto-create default business for owners
...
google_sheet_tab_name TEXT DEFAULT 'Records',
...
-- Businesses: owners see own; admins see all; public can view active businesses
...
-- Calls: public can log web calls, owner and admin manage
...
-- Appointments: public can book appointments, owner and admin manage
...
-- API Usage: allow inserts, owner view own, admin view/manage all
...
-- Billing: owner view own, admin manage all
